...
class AboutArrays < Neo::Koan
  ...
  def test_slicing_arrays
    ...
    assert_equal __(%i[peanut butter]), array[0, 2]
    assert_equal __(%i[and jelly]), array[2, 2]
    assert_equal __(%i[and jelly]), array[2, 20]
  ...
  def test_slicing_with_ranges
    ...
    assert_equal __(%i[peanut butter and]), array[0..2]
    assert_equal __(%i[peanut butter]), array[0...2]
    assert_equal __(%i[and jelly]), array[2..-1]
  end
